/**
 * UI Manager - UPDATED VERSION with new pair/disconnect buttons
...
export class UIManager extends EventEmitter {
    ...
    cacheElements() {
        ...
        // NEW: Device pair and disconnect buttons
        this.elements.pairKickrBtn = document.getElementById('pair-kickr-btn');
        this.elements.pairZwiftBtn = document.getElementById('pair-zwift-btn');
        this.elements.pairHrmBtn = document.getElementById('pair-hrm-btn');
        this.elements.disconnectKickrBtn = document.getElementById('disconnect-kickr-btn');
        this.elements.disconnectZwiftBtn = document.getElementById('disconnect-zwift-btn');
        this.elements.disconnectHrmBtn = document.getElementById('disconnect-hrm-btn');
        
        // OLD: Device buttons (keeping for backward compatibility)
    ...
    setupEventListeners() {
        ...
        // NEW: Device pairing buttons
        if (this.elements.pairKickrBtn) {
            this.elements.pairKickrBtn.addEventListener('click', () => {
                this.emit('device-pair-requested', 'kickr');
            });
        }
        
        if (this.elements.pairZwiftBtn) {
            this.elements.pairZwiftBtn.addEventListener('click', () => {
                this.emit('device-pair-requested', 'zwift-click');
            });
        }
        
        if (this.elements.pairHrmBtn) {
            this.elements.pairHrmBtn.addEventListener('click', () => {
                this.emit('device-pair-requested', 'hrm');
            });
        }
        
        // NEW: Device disconnect buttons
        if (this.elements.disconnectKickrBtn) {
            this.elements.disconnectKickrBtn.addEventListener('click', () => {
                this.emit('device-disconnect-requested', 'kickr');
            });
        }
        
        if (this.elements.disconnectZwiftBtn) {
            this.elements.disconnectZwiftBtn.addEventListener('click', () => {
                this.emit('device-disconnect-requested', 'zwift-click');
            });
        }
        
        if (this.elements.disconnectHrmBtn) {
            this.elements.disconnectHrmBtn.addEventListener('click', () => {
                this.emit('device-disconnect-requested', 'hrm');
            });
        }
        
        // OLD: Device pairing buttons (backward compatibility)
    ...
    setDeviceButtonsEnabled(enabled) {
        const buttons = [
            // NEW buttons (primary ones we want to enable/disable)
            this.elements.pairKickrBtn,
            this.elements.pairZwiftBtn,
            this.elements.pairHrmBtn,
            this.elements.disconnectKickrBtn,
            this.elements.disconnectZwiftBtn,
            this.elements.disconnectHrmBtn,
            // OLD buttons (backward compatibility)
